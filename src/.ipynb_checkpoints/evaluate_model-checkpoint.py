...
def evaluate_model(model_path='models/iris_model.pkl', scaler_path='models/scaler.pkl', data_path='data/iris.csv'):
    ...
    # Start an MLflow run if one is not active
    ...
    # --- Fairlearn Part ---
    # Use MetricFrame to assess fairness
    metrics = {
        'accuracy': accuracy_score,
        'recall_per_class': lambda y_true, y_pred: recall_score(y_true, y_pred, average=None),
    ...
    # Print the fairness metrics to the console
